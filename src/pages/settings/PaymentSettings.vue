...
export default {
  ...
  data.append('hash_rate_electricity_consumption', parseInt(settings.hash_rate_electricity_consumption));
...
<template>
  <section class="wrapper">
    ...
    <div class="card">
      <div class="group">
        <label for="bank" class="group-value"
          >Данные оплаты (Банковская карта)</label
        >
        <input
          type="text"
          id="bank"
